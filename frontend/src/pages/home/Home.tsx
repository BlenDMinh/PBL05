    ...
    <div className='flex flex-col w-full h-full items-center py-10 px-16 gap-20'>
      <div className='flex flex-col gap-5 w-full'>
        <div className='w-full flex gap-5'>
          <Link to={`/profile/${user?.id}`} className='avatar btn btn-circle btn-ghost'>
      ...
      <div className='flex w-full gap-10 h-96'>
        <div className='flex flex-col w-1/3 h-full justify-evenly gap-10'>
          <Link className='btn bg-base-200 w-full h-1/4 border-b-8 border-base-300' to='/game/quickmatch'>
            <span className='text-base-content font-bold text-xl flex gap-2 items-center'><FaClock/>Quick Match</span>
          </Link>
          <Link to='/game/v2/play-with-bot' className='btn bg-base-200 w-full h-1/4 border-b-8 border-base-300'>
            <span className='text-base-content font-bold text-xl flex gap-2 items-center'><FaRobot/>Play with bot</span>
          </Link>
          <div className='tooltip h-1/4' data-tip="Currently not available">
            <div className='btn bg-base-200 w-full h-full border-b-8 border-base-300'>
              <span className='text-base-content font-bold text-xl flex gap-2 items-center'><FaUser />Play with friends</span>
            </div>
          </div>
        </div>
        <div className='card bg-base-200 h-full w-1/3 border-b-8 border-base-300'>
          <figure><img src="/puzzle.jpeg" alt="Shoes" /></figure>
        ...
        <div className='card bg-base-200 h-full w-1/3 border-b-8 border-base-300'>
          <figure><img src="/robot.jpg" alt="Shoes" /></figure>
          <div className="card-body">
            <h2 className="card-title">Play with AI</h2>
            <p>Challenge yourself with smart Artifical Intelligent</p>
            <div className="card-actions justify-end">
              <Link to='/game/v2/play-with-bot' className="btn btn-primary">Play</Link>
            </div>
          </div>
        </div>
      </div>
