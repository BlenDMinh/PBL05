  ...
  return (
    <div className='flex flex-col h-full w-full items-center gap-5'>
      ...
      <h2 className='text-lg'>
        You are almost there. We have sent a <span className='font-bold'>6-digits code</span> to your registed email.
        Visit your mail and complete the sign up
      </h2>
      <h2 className='text-lg'>If you don't see it, try checking your spam folder</h2>
      <input
        className={classNames('input input-lg border-2 bg-base-200 font-bold text-lg focus:ring-0 focus:border-0', {
        ...
        onChange={verify}
      />
      <div className='h-36'>{verifying && <span className='loading loading-spinner loading-lg'></span>}</div>
