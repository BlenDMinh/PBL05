...
export default function FriendList() {
    const id = useMemo(() => getProfileFromLS().id, [])
    ...
    return <>
          ...
          <div className='w-full flex gap-3 items-center mb-3'>
            <input value={keyword} onChange={(e) => setKeyword(e.target.value)} className='flex-1 input input-primary' placeholder='Search your friends' />
