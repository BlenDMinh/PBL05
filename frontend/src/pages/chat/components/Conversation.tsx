...
export default function Conversation(props: ConversationProps) {
  ...
  return (
    ...
    >
      <div className='avatar h-12 w-12 min-h-[3rem] min-w-[3rem]'>
        <img
          className='rounded-full'
          alt='Avatar'
          src={props.conversation.avatarUrl ?? 'https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg'}
        />
        <div className='absolute bg-accent rounded-full w-5 h-5 border border-accent-content'></div>
      </div>
      <div className='flex-1 flex flex-col items-start justify-evenly gap-2 max-w-[calc(70%)]'>
        ...
        <div className='flex w-full'>
          <p className='text-start w-4/5 text-base-content font-thin truncate'>
            {props.conversation.message.isFromUser ? 'You: ' : ''}
            {props.conversation.message.content}
          </p>
